...
function  Crc32 (PStr: myPChar; StrLen: integer): integer;
function  AnsiCrc32 (const Str: myAStr): integer;

(* Warning! Requires SSE 4.2 support. Shows 8X performance, as compared to 1-byte tabular CRC32 implementation *)
function Crc32c (PStr: myPChar; StrLen: integer): integer;
function AnsiCrc32c (const Str: myAStr): integer;
...
var
  ...
  FastHash:     function (PStr: myPChar; StrLen: integer): integer;
  FastAnsiHash: function (const Str: myAStr): integer;
...
function Crc32c (PStr: myPChar; StrLen: integer): integer; assembler;
asm
  push edi
  mov edi, eax
  xor eax, eax
...
begin
  Sse42Supported := UtilsB2.IsSse42Supported;
  FastHash       := Crc32;
