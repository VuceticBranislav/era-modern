...
type
  ...
  TOnAfterEntryExtractHandler = function (filename: myPChar; arg: pointer): integer;


function zip_strerror (errnum: integer): myPChar; cdecl external LIB_KUBAZIP;
function zip_open (zipname: myPChar; level: integer; mode: myChar): PZipStruct; cdecl external LIB_KUBAZIP;
...
function zip_entry_open (zip: PZipStruct; entryname: myPChar): integer; cdecl external LIB_KUBAZIP;
...
function zip_entry_name (zip: PZipStruct): myPChar; cdecl external LIB_KUBAZIP;
...
function zip_entry_fwrite (zip: PZipStruct; filename: myPChar): integer; cdecl external LIB_KUBAZIP;
...
function zip_entry_fread (zip: PZipStruct; filename: myPChar): integer; cdecl external LIB_KUBAZIP;
...
function zip_entries_delete (zip: PZipStruct; filenames: UtilsB2.PEndlessPCharArr; len: integer): integer; cdecl external LIB_KUBAZIP;
function zip_stream_extract (stream: myPChar; size: integer; dir: myPChar; onAfterEntryExtract: TOnAfterEntryExtractHandler; arg: pointer): integer; cdecl external LIB_KUBAZIP;
function zip_stream_open (stream: myPChar; size: integer; level: integer; mode: byte): PZipStruct; cdecl external LIB_KUBAZIP;
...
function zip_create (zipname: myPChar; filenames: UtilsB2.PEndlessPCharArr; len: integer): integer; cdecl external LIB_KUBAZIP;
function zip_extract (zipname: myPChar; dir: myPChar; onAfterEntryExtract: TOnAfterEntryExtractHandler; arg: pointer): integer; cdecl external LIB_KUBAZIP;
