...
function RegisterMemoryConsumer (ConsumerName: myAStr): pinteger;
...
const
  ...
  GAME_MEM_CONSUMER_NAME              : myAStr = '<Heroes 3>';
  TICKETLESS_MEM_CONSUMERS_GROUP_NAME : myAStr = '<Others>';
...
begin
  ...
  MemoryConsumers := DataLib.NewStrList(not UtilsB2.OWNS_ITEMS, DataLib.CASE_SENSITIVE);
